    ...
    try {
     ...
     const fetchPictureDetails = async () => {
      ...
      console.log ({record, status})
          ...
          setImageURLs(prevImageURLs => [...prevImageURLs, {imageUrl, imageId}]);
        })
      ...
      try {
        ...
        if (response.records && response.records.length > 0) {
          ...
          if (deleteResult.status.code === 202) {
            ...
            setImageURLs(prevPictureDetails => prevPictureDetails.filter(message => message.imageId !== recordId));
          } else {
    ...
    const sharePictureDetails = async (recordId: string) => {
      ...
      try {
        ...
        if (response.records && response.records.length > 0) {
          ...
          toast.success('Successfully shared picture', {
            position: toast.POSITION.TOP_RIGHT,
            autoClose: 3000,
          });
          ...
          console.error('No record found with the specified ID');
          toast.error('Failed to share picture', {
            position: toast.POSITION.TOP_RIGHT,
            autoClose: 3000,
          });
        }
                  ...
                  <div className="flex w-full lg:w-2/5" key={index}>
                    <div className=' mb-5'>
                      <div className="w-full mb-5 text-xs text-gray-500 dark:text-gray-400">
                            ...
                            >
                              <div
                                ...
                                <div
                                  ...
                                  ">        
                                    <div className="flex flex-row justify-between ">
                                      <h2 className="text-xl font-semibold mb-4">Share Picture</h2>
                                      <div className="flex justify-end">
                                        <button
                                ...
                                <div className="-mx-4 flex flex-wrap">
                                  ...
                                  <div className="w-full px-4">
                                    <button 
                                      type="button"
                                      onClick={() => sharePictureDetails(image.imageId)}
                        ...
                        <div className="relative">
                          <button
                            onClick={() => showDeleteConfirmation(image.imageId)}
                                ...
                                <div className="mt-4 flex justify-end">
                                  ...
                                  <button
                                    onClick={() => {
                                      ...
                                      deletePictureDetails(image.imageId);
                                    }}
